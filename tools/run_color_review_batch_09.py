...
source = source.replace("партия 2", "партия 9 — 20 товаров")
source = source.replace("color-review-batch-02", "color-review-batch-09")
generated = root / "tools" / ".build_color_review_sheet_batch09.py"
