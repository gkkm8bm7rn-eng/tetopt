(()=>{
  const id='hero-banner-final-style';
...
.hero-main:before{display:none!important;content:none!important;background:none!important}
.hero-main>*{position:relative!important;z-index:1!important;min-width:0!important}
...
.forma-hero-stat:nth-child(2) span{color:rgba(255,255,255,.82)!important}
...
@media(max-width:900px){
  ...
  .forma-hero-bottom{max-width:none!important}
}
@media(max-width:760px){
  ...
  .hero-main .eyebrow,.hero-main .kicker{font-size:11px!important;line-height:1.35!important;margin-bottom:12px!important}
  .hero-main h1{font-size:clamp(38px,10.8vw,52px)!important;line-height:1.01!important;margin-bottom:14px!important;max-width:none!important}
  .hero-main p{font-size:16px!important;line-height:1.45!important;max-width:none!important}
  .forma-hero-bottom{gap:9px!important;margin-top:15px!important}
  .hero-actions .btn-primary,.hero-actions a[href*='#catalog'],.hero-actions button[data-scroll-to-catalog]{min-height:60px!important;border-radius:18px!important;font-size:17px!important;padding:13px 16px!important;gap:14px!important}
  .hero-actions .btn-primary:after,.hero-actions a[href*='#catalog']:after,.hero-actions button[data-scroll-to-catalog]:after{font-size:27px!important}
  .forma-hero-stat{min-height:92px!important;padding:12px 14px!important;border-radius:18px!important;gap:10px!important;justify-content:flex-start!important}
...
@media(max-width:390px){
  ...
  .forma-hero-stat{min-height:84px!important;padding:10px 10px!important;gap:7px!important}
