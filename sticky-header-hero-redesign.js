(()=>{
  ...
  function injectStyles(){
    ...
    style.textContent=`
      ...
      .forma-hero-stats{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin:26px 0 14px}
      .forma-hero-stat{display:flex;align-items:center;justify-content:space-between;gap:10px;padding:13px 16px;border:1px solid rgba(93,107,79,.22);border-radius:18px;background:rgba(255,255,255,.72);backdrop-filter:blur(12px);box-shadow:0 8px 22px rgba(47,42,33,.08)}
      .forma-hero-stat strong{font-family:Georgia,serif;font-size:28px;font-weight:500;line-height:1;color:#201f1b}
      .forma-hero-stat span{font-size:12px;font-weight:800;line-height:1.2;color:#5d6b4f;text-transform:uppercase;letter-spacing:.04em;text-align:right}
      ...
      @media(max-width:760px){
        ...
        .forma-hero-stats{gap:8px;margin:22px 0 12px}
        .forma-hero-stat{padding:11px 12px;border-radius:16px}
        .forma-hero-stat strong{font-size:24px}
        .forma-hero-stat span{font-size:10px}
      ...
      @media(max-width:390px){
        ...
        .forma-hero-stat{padding:10px}
        .forma-hero-stat strong{font-size:22px}
      }
    `;
  ...
  function setupHeroStats(){
    ...
    let box=heroMain.querySelector('.forma-hero-stats');
    if(!box){
